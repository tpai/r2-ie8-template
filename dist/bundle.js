...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcStoreStore = __webpack_require__(178);

	var _srcStoreStore2 = _interopRequireDefault(_srcStoreStore);

	var _AppRouter = __webpack_require__(185);

	var _AppRouter2 = _interopRequireDefault(_AppRouter);

	(0, _reactDom.render)(_react2["default"].createElement(
		_reactRedux.Provider,
		{ store: (0, _srcStoreStore2["default"])() },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postList = __webpack_require__(182);

	var list = _interopRequireWildcard(_postList);

	var _postCtnt = __webpack_require__(184);

	var ctnt = _interopRequireWildcard(_postCtnt);

	var reducers = (0, _objectAssign2["default"])(list, ctnt);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsTypes = __webpack_require__(183);

	var list = function list(state, action) {
		if (state === undefined) state = [];

		switch (action.type) {
			case _actionsTypes.RECEIVE_LIST:
				return action.list;
			default:
				return state;
		}
...
/***/ function(module, exports) {
	...
	var RECEIVE_CTNT = "RECEIVE_CTNT";
	exports.RECEIVE_CTNT = RECEIVE_CTNT;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctnt = function ctnt(state, action) {
		if (state === undefined) state = {};

		switch (action.type) {
			case _actionsTypes.RECEIVE_CTNT:
				return (0, _objectAssign2["default"])({}, state, action.ctnt);
			default:
				return (0, _objectAssign2["default"])({}, state, { title: "Now", body: "Loading..." });
		}
	};
	exports.ctnt = ctnt;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcComponentsList = __webpack_require__(237);

	var _srcComponentsList2 = _interopRequireDefault(_srcComponentsList);

	var _srcComponentsCtnt = __webpack_require__(239);
		...
		_createClass(AppRouter, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(_reactRouter.Route, { path: "/content/:id", component: _srcComponentsCtnt2["default"] })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoutingContext = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parsePath = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extractPath = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsList = __webpack_require__(238);
	...
	var List = (function (_Component) {
		...
		_createClass(List, [{
			...
			value: function componentDidMount() {
				...
				dispatch((0, _actionsList.fetchList)());
			}
		}, {
			key: "render",
			value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var receiveList = function receiveList(json) {
		return {
			type: _types.RECEIVE_LIST,
			list: json
		};
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsCtnt = __webpack_require__(240);
	...
	var Ctnt = (function (_Component) {
		...
		function Ctnt() {
			...
			_get(Object.getPrototypeOf(Ctnt.prototype), "constructor", this).apply(this, arguments);
		}
		...
		_createClass(Ctnt, [{
			...
			value: function componentDidMount() {
				...
				dispatch((0, _actionsCtnt.fetchCtnt)(params.id));
			}
		}, {
			key: "render",
			value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchCtnt = function fetchCtnt(id) {
		return function (dispatch) {
			$.ajax({
				type: "GET",
				url: "http://jsonplaceholder.typicode.com/posts/" + id
			}).done(function (data) {
				return dispatch(receiveCtnt(data));
			});
		};
	};

	exports.fetchCtnt = fetchCtnt;
	var receiveCtnt = function receiveCtnt(json) {
		return {
			type: _types.RECEIVE_CTNT,
			ctnt: {
				title: json.title,
				body: json.body
			}
